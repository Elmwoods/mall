<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"F:\wamp\www\tp5\admin\index\view\index\index.html";i:1463815127;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					...
					<li><a _href="feedback-list.html" data-title="意见反馈" href="/static/admin/javascript:void(0)">意见反馈</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-member">
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo U('users/admin_role'); ?>" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
					<li><a _href="<?php echo U('users/admin_permission'); ?>" data-title="权限管理" href="javascript:void(0)">权限管理</a></li>
					<li><a _href="<?php echo U('users/admin_list'); ?>" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-tongji">
